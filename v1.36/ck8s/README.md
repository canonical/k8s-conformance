...
Follow the instructions at https://documentation.ubuntu.com/canonical-kubernetes/release-1.36/snap/tutorial/add-remove-nodes/ to install Canonical Kubernetes on two machines.
...
1. Download a [binary release](https://github.com/vmware-tanzu/sonobuoy/releases) of sonobuoy, or build it yourself by running:
```sh
