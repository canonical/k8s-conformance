...
Follow the instructions at https://documentation.ubuntu.com/canonical-kubernetes/release-1.35/snap/tutorial/add-remove-nodes/ to install Canonical Kubernetes on two machines.
